  ...
  return (
    <div className="carousel">
      <Slider
        ...
        {slides.map((slide) => (
          <div className="carousel__slide" key={slide.link}>
            <Slide link={slide.link} name={slide.name} img={slide.img} />
          </div>
        ))}
      </Slider>
    </div>
...
const CarouselNext = (props: { onClick?: () => void }) => {
  const { onClick } = props;
  return (
    <button className="carousel__button" type="button" onClick={onClick}>
      <svg
        width="10"
        height="18"
        viewBox="0 0 10 18"
...
const CarouselPrev = (props: { onClick?: () => void }) => {
  const { onClick } = props;
  return (
    <button className="carousel__button" type="button" onClick={onClick}>
      <svg
